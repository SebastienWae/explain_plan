const postgresqlExamples = {
  ...
  "single cte": `[
  {
    "Plan": {
      ...
      "Plan Rows": 3,
      "Plan Width": 4,
      "Actual Startup Time": 100.290,
      "Actual Total Time": 300.584,
      "Actual Rows": 3.00,
      "Actual Loops": 1,
      "Disabled": false,
      "Shared Hit Blocks": 0,
      ...
      "Plans": [
        {
          ...
          "Plan Rows": 2,
          "Plan Width": 4,
          "Actual Startup Time": 100.272,
          "Actual Total Time": 300.527,
          "Actual Rows": 2.00,
          "Actual Loops": 1,
          "Disabled": false,
          "Shared Hit Blocks": 0,
          ...
          "Plans": [
            {
              ...
              "Plan Rows": 1,
              "Plan Width": 4,
              "Actual Startup Time": 100.268,
              "Actual Total Time": 100.271,
              "Actual Rows": 1.00,
              "Actual Loops": 1,
              "Disabled": false,
              "Output": ["pg_sleep_for.pg_sleep_for"],
              "Function Call": "pg_sleep(((EXTRACT(epoch FROM (clock_timestamp() + '00:00:00.1'::interval)) - EXTRACT(epoch FROM clock_timestamp())))::double precision)",
              "Shared Hit Blocks": 0,
              "Shared Read Blocks": 0,
              "Shared Dirtied Blocks": 0,
              "Shared Written Blocks": 0,
            ...
            },
            {
              ...
              "Function Name": "pg_sleep",
              "Schema": "pg_catalog",
              "Alias": "pg_sleep_for_1",
              "Startup Cost": 0.02,
              "Total Cost": 0.03,
              "Plan Rows": 1,
              "Plan Width": 4,
              "Actual Startup Time": 200.231,
              "Actual Total Time": 200.235,
              "Actual Rows": 1.00,
              "Actual Loops": 1,
              "Disabled": false,
              "Output": ["pg_sleep_for_1.pg_sleep_for"],
              "Function Call": "pg_sleep(((EXTRACT(epoch FROM (clock_timestamp() + '00:00:00.2'::interval)) - EXTRACT(epoch FROM clock_timestamp())))::double precision)",
              "Shared Hit Blocks": 0,
              "Shared Read Blocks": 0,
              "Shared Dirtied Blocks": 0,
              "Shared Written Blocks": 0,
        ...
        },
        {
          ...
          "Plan Rows": 1,
          "Plan Width": 4,
          "Actual Startup Time": 100.286,
          "Actual Total Time": 100.292,
          "Actual Rows": 1.00,
          "Actual Loops": 1,
          "Disabled": false,
          "Output": ["init_1.pg_sleep_for"],
          "Shared Hit Blocks": 0,
          "Shared Read Blocks": 0,
          "Shared Dirtied Blocks": 0,
          "Shared Written Blocks": 0,
          ...
          "Plans": [
            {
              ...
              "Plan Rows": 2,
              "Plan Width": 4,
              "Actual Startup Time": 100.279,
              "Actual Total Time": 100.280,
              "Actual Rows": 1.00,
              "Actual Loops": 1,
              "Disabled": false,
              "Output": ["init_1.pg_sleep_for"],
        ...
        },
        {
          ...
          "Actual Total Time": 200.259,
          "Actual Rows": 2.00,
          "Actual Loops": 1,
          "Disabled": false,
          "Output": ["init.pg_sleep_for"],
          "Storage": "Memory",
          "Maximum Storage": 17,
          "Shared Hit Blocks": 0,
          "Shared Read Blocks": 0,
